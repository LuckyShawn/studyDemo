 ...
 * @title: FindNumOfValidWords  1178. 猜字谜  （困难）
...
public class FindNumOfValidWords {
    ...
    public static void main(String[] args) {
        System.out.println(findNumOfValidWords(new String[]{"aaaa","asas","able","ability","actt","actor","access"},new String[]{"aboveyz","abrodyz","abslute","absoryz","actresz","gaswxyz"}).toString());
    }
    ...
    public List<Integer> findNumOfValidWords01(String[] words, String[] puzzles) {
        root = new TrieNode();
